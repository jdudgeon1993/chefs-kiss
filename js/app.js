...
function editShoppingItem(itemKey, name, quantity, unit, category) {
  ...
  const sourceNote = isAutoGenerated
    ? `<p class="help-text" style="margin-bottom:0.75rem;font-size:0.8rem;">This item is auto-calculated from ${existingItem.source || 'meals/threshold'}. Saving will pin your values as a manual override. Delete the override to restore auto-calculation.</p>`
    : '';
      ...
      <div class="modal-content edit-shopping-modal" onclick="event.stopPropagation()">
        ...
        <form id="edit-shopping-form">
          ...
          <div class="form-row">
            ...
            <div class="form-group">
              <label>Unit</label>
              <input type="text" id="edit-item-unit" value="${unit}" placeholder="lb, oz, etc" list="unit-suggestions">
            </div>
            <div class="form-group">
          ...
          <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary">${isAutoGenerated ? 'Save Override' : 'Save Changes'}</button>
          </div>
        </form>
      </div>
    </div>
