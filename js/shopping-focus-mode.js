  ...
  openEditModal(itemKey) {
    ...
    modal.innerHTML = `
      <div class="focus-modal">
        <h3>Edit Item</h3>
        ${isAutoGenerated ? `<p style="font-size:0.8rem;opacity:0.7;margin:0 0 0.75rem;">Auto-calculated from ${item.source || 'meals/threshold'}. Saving pins your values as an override.</p>` : ''}
